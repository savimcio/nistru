...
- Touching [internal/editor/editor.go](internal/editor/editor.go) (Ctrl-shortcut mappings, mode synthesis) → [internal/editor/editor_test.go](internal/editor/editor_test.go); beware the `synthVimMotion` regression fix from commit `0ee96ea` (Ctrl shortcuts must transit Normal mode).
